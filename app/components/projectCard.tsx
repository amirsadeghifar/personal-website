  ...
  return (
    ...
    >
      <div className="flex justify-between overflow-visible">
        ...
        <span className="flex gap-2 h-fit overflow-visible">
          {live && (
            <Link
              className="group overflow-visible hover:scale-[1.07] hover:rotate-3 transition-all ease-out"
              href={live}
              target="_blank"
            >
              <svg
              ...
              >
                <path className="" d="M15 3h6v6" />
                <path className="" d="M10 14 21 3" />
                <path
                  className=""
      ...
      <div className="flex justify-between md:flex-row flex-col gap-5 flex-wrap">
        <div className="flex gap-3 flex-wrap">
          {skills &&
            skills.map((skill) => (
              <div key={skill} className="skill-card px-2 py-1 rounded-md">
                {skill}
              </div>
            ))}
        </div>
        ...
        <div className="lg:relative lg:-bottom-24 absolute -bottom-80 transition-all">
          <a href="https://splinter-app.github.io" target="_blank">
            <motion.img
              ...
              width={800}
              height={500}
              alt="webportfolios project preview"
            />
          </a>
        </div>
      </div>
